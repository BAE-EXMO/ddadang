...
export default function ScreenReviewsSection() {
  ...
  const reviews: Review[] = [
    ...
    },
    {
      id: 31,
      name: "곽민준",
      business: "드라이빙레인지 부지배인",
      rating: 5,
      date: "2024.07.22",
      title: "야간 조명 아래서도 선명합니다",
      content: "야간 영업용 실내 타석 10곳에 설치했어요. LED 조명 아래서도 반사 없이 깨끗하고, 회원들이 저녁 시간대 이용이 급증했습니다. 투자 대비 효과가 3개월 만에 나타났어요.",
      helpful: 115
    },
    {
      id: 32,
      ...
      rating: 5,
      date: "2024.07.18",
      title: "도심 한복판에서 프라이빗 골프장",
      content: "강남 빌딩 옥상에 개인 연습장 만들었어요. 바람이 많이 부는 환경인데도 스크린이 튼튼하고, 도심 야경 보면서 골프 치니까 스트레스가 확 풀립니다. 지인들 부러움 독차지!",
      helpful: 68
    },
    {
      id: 33,
      name: "남궁철",
      business: "재활병원 물리치료실 실장",
      rating: 5,
      date: "2024.07.15",
      title: "재활 운동용으로도 활용 가능해요",
      content: "재활치료 프로그램에 골프를 도입하면서 설치했습니다. 충격이 부드러워서 수술 후 환자들도 안전하게 운동할 수 있고, 재활 동기 부여에도 효과적입니다. 의료진들도 만족해요.",
      helpful: 94
    },
    {
      id: 34,
      ...
      date: "2024.07.12",
      title: "이웃과 공유하며 사용 중",
      content: "타운하우스 공용 공간에 설치하고 이웃 3가구와 함께 사용해요. 설치 비용을 나눠서 부담도 적고, 주말마다 이웃들과 친목 도모하면서 골프 즐기니 일석이조입니다.",
      helpful: 81
    },
    {
      id: 35,
      ...
      rating: 5,
      date: "2024.07.08",
      title: "매장 체험존으로 최고의 선택",
      content: "골프웨어 매장 안에 체험존 만들면서 1타석 설치했어요. 고객들이 옷 입고 직접 스윙해볼 수 있어서 구매 전환율이 40% 올랐습니다. 매장 차별화에 큰 도움이 됐어요.",
      helpful: 107
    },
    {
      id: 36,
      name: "소혜진",
      business: "초등학교 방과후 교사",
      rating: 5,
      date: "2024.07.05",
      title: "어린이 골프교실에 안성맞춤",
      content: "초등학교 방과후 골프교실에서 사용하고 있어요. 안전하고 소음이 적어서 학교 측에서도 만족하고, 아이들이 재미있어하면서 집중력도 좋아졌습니다. 학부모님들 문의도 많아요.",
      helpful: 73
    },
    {
      id: 37,
      ...
      rating: 5,
      date: "2024.07.01",
      title: "문화공간과의 조화가 완벽해요",
      content: "북카페 겸 갤러리에 골프존 만들면서 설치했어요. 세련된 디자인이 공간과 잘 어울리고, 문화 프로그램과 골프를 함께 즐기려는 고객층이 새로 생겼습니다. 브랜딩에도 도움돼요.",
      helpful: 86
    },
    {
      id: 38,
      name: "민서연",
      business: "KLPGA 투어 지망생",
      rating: 5,
      date: "2024.06.28",
      title: "프로 지망생에게 필수 장비입니다",
      content: "개인 훈련실에 설치하고 매일 500타 이상 연습해요. 날씨 걱정 없이 일정한 환경에서 훈련할 수 있어 실력 향상에 큰 도움됩니다. 투어 진출하면 홍보 모델로 나서고 싶어요!",
      helpful: 122
    },
    {
      id: 39,
      ...
      rating: 5,
      date: "2024.06.25",
      title: "농촌 관광 활성화에 기여합니다",
      content: "체험마을 커뮤니티센터에 설치했어요. 도시 관광객들이 골프 체험하러 많이 오시고, 주말 체류 시간도 길어졌습니다. 농촌 소득 증대에 실질적 도움이 되고 있어요.",
      helpful: 64
    },
    {
      id: 40,
      ...
      rating: 5,
      date: "2024.06.22",
      title: "직원 복지와 업무 효율 모두 잡았어요",
      content: "사무실 라운지에 2타석 설치하니 직원들 점심시간 활용도 높아지고, 업무 스트레스도 풀립니다. 채용 시 복지 어필 포인트로도 좋고, 직원 만족도가 눈에 띄게 올랐어요.",
      helpful: 99
    },
    {
      id: 41,
      name: "차은수",
      business: "개인 (다세대주택 옥상)",
      rating: 4,
      date: "2024.06.18",
      title: "좁은 옥상도 맞춤 제작 가능",
      content: "다세대주택 옥상 5평 공간에 소형으로 제작했어요. 가격은 조금 나갔지만 맞춤 제작이 가능해서 좋았고, 동네 골프 동호회 친구들이 자주 놀러 와서 즐겁게 사용하고 있습니다.",
      helpful: 57
    },
    {
      id: 42,
      name: "나승우",
      business: "종합레저타운 사업본부장",
      rating: 5,
      date: "2024.06.15",
      title: "대규모 시설에도 안정적입니다",
      content: "레저타운 내 골프존 15타석 전체 교체했습니다. 대량 발주에도 납기 준수하고 품질도 일정해서 만족스럽습니다. 1년 사용 후 재계약 예정이고, 추가 확장도 검토 중이에요.",
      helpful: 143
    },
    {
      id: 43,
      ...
      rating: 5,
      date: "2024.06.12",
      title: "원룸에서도 골프 연습 가능해요",
      content: "원룸 베란다 확장해서 초소형 설치했어요. 어프로치 연습용으로 딱이고, 밤늦게 연습해도 이웃 민원 없습니다. 직장인 골퍼들에게 완전 추천! 집에서 매일 30분씩 연습하니 실력이 늘어요.",
      helpful: 88
    },
    {
      id: 44,
      name: "엄지호",
      business: "군부대 체육시설 담당관",
      rating: 5,
      date: "2024.06.08",
      title: "장병 복지 향상에 큰 기여",
      content: "부대 체육관에 3타석 설치했습니다. 장병들 여가 활동 만족도가 높아지고, 전역 후에도 골프 취미를 이어갈 수 있는 기회가 됐습니다. 상급 부대에서도 모범 사례로 소개됐어요.",
      helpful: 76
    },
    {
      id: 45,
      ...
      rating: 5,
      date: "2024.06.05",
      title: "어르신들 치매 예방에 효과적",
      content: "요양원 재활실에 2타석 설치했어요. 어르신들이 골프 치시면서 인지 기능 향상에 도움이 되고, 우울증도 개선되는 효과가 있습니다. 의료진들도 긍정적으로 평가하고 있어요.",
      helpful: 91
    },
    {
      id: 46,
      ...
      rating: 5,
      date: "2024.06.01",
      title: "현장 근로자 복지 시설로 최고",
      content: "대규모 건설현장 가건물에 설치했어요. 주말에 현장 남은 근로자들이 스트레스 풀 수 있는 공간이 돼서 근무 만족도가 높아졌습니다. 안전사고도 줄고 일석이조네요.",
      helpful: 69
    },
    {
      id: 47,
      ...
      rating: 5,
      date: "2024.05.28",
      title: "상가 세입자들과 함께 사용해요",
      content: "상가주택 옥상에 설치하고 1층 상가 세입자들에게 무료 개방했어요. 세입자 만족도 높아지고 임대료 협상도 수월해졌습니다. 임대 공실률이 0%로 유지되고 있어요.",
      helpful: 62
    },
    {
      id: 48,
      ...
      rating: 5,
      date: "2024.05.25",
      title: "촬영용으로 화질이 뛰어나요",
      content: "골프 레슨 영상 촬영용으로 설치했는데, 조명 반사 없이 깔끔하게 나와서 촬영 퀄리티가 확 올랐어요. 구독자들도 영상 품질 좋아졌다고 칭찬하고, 협찬 문의도 받았습니다!",
      helpful: 134
    },
    {
      id: 49,
      ...
      rating: 5,
      date: "2024.05.22",
      title: "야외 웨딩 대기 공간으로 활용",
      content: "가든 웨딩홀 대기 공간에 이동형 스튜디오와 함께 설치했어요. 하객들이 식 전후 골프 체험하며 즐기시고, 웨딩 콘셉트로도 특별해서 예약 문의가 30% 늘었습니다.",
      helpful: 77
    },
    {
      id: 50,
      ...
      date: "2024.05.18",
      title: "전원생활과 골프를 동시에",
      content: "주말농장 쉼터에 설치했어요. 농사일 끝나고 골프로 몸 푸니 일주일 피로가 확 풀립니다. 전원생활의 낭만과 골프 취미를 동시에 즐길 수 있어 최고의 투자였습니다.",
      helpful: 59
    },
    {
      id: 51,
      ...
      rating: 5,
      date: "2024.05.15",
      title: "기업 연수 프로그램에 인기",
      content: "수련원 레크리에이션 시설로 4타석 설치했어요. 기업 워크샵 프로그램에 골프 체험을 포함하니 만족도가 높아지고, 재방문율도 50% 이상 올랐습니다. 매출 증대 효과 확실해요.",
      helpful: 96
    },
    {
      id: 52,
      name: "서윤지",
      business: "개인 (다가구주택 지하)",
      rating: 4,
      date: "2024.05.12",
      title: "지하 습기에도 견딥니다",
      content: "다가구주택 반지하 창고를 개조해서 설치했어요. 습기가 많은 환경인데도 곰팡이나 변색 없이 6개월째 잘 사용 중입니다. 단, 환기는 자주 시켜주는 게 좋을 것 같아요.",
      helpful: 53
    },
    {
      id: 53,
      name: "길동욱",
      business: "골프 장비 수입사 이사",
      rating: 5,
      date: "2024.05.08",
      title: "쇼룸 시연용으로 완벽합니다",
      content: "수입 골프채 쇼룸에 3타석 설치하고 고객 시연용으로 사용해요. 타구감이 정확해서 장비 성능을 제대로 테스트할 수 있고, 고객들 구매 결정에 큰 도움이 됩니다. 매출 상승 효과 있어요.",
      helpful: 118
    },
    {
      id: 54,
      name: "성민지",
      business: "개인 (듀플렉스 테라스)",
      rating: 5,
      date: "2024.05.05",
      title: "테라스 뷰 보며 치는 골프 최고",
      content: "듀플렉스 테라스에 설치해서 한강 뷰 보면서 골프 칩니다. 친구들 초대하면 다들 감탄하고, 집들이 선물로도 좋다고 추천받았어요. 삶의 질이 확실히 올라간 느낌입니다!",
      helpful: 105
    },
    {
      id: 55,
      ...
      rating: 5,
      date: "2024.05.01",
      title: "청소년 골프 저변 확대에 기여",
      content: "청소년수련관 체육시설에 5타석 설치했습니다. 청소년들이 저렴한 비용으로 골프를 접할 수 있게 되어 반응이 폭발적입니다. 골프 저변 확대에 실질적으로 기여하고 있어요.",
      helpful: 87
    },
    {
      id: 56,
      name: "변재희",
      business: "콘도 레저시설 파트장",
      rating: 5,
      date: "2024.04.28",
      title: "회원권 가치 상승 효과",
      content: "회원제 콘도 레저시설 리모델링하면서 8타석 설치했어요. 회원들 만족도가 급상승하면서 회원권 시세도 올랐습니다. 시설 투자 대비 회원권 가치 상승 효과가 확실합니다.",
      helpful: 112
    },
    {
      id: 57,
      ...
      rating: 5,
      date: "2024.04.25",
      title: "정원에 설치하니 힐링 그 자체",
      content: "전원주택 넓은 정원에 이동형 스튜디오와 함께 설치했어요. 자연 속에서 골프 치는 기분이 최고이고, 가족들도 주말마다 함께 즐기고 있습니다. 전원생활의 백미입니다!",
      helpful: 128
    }
  ];
      ...
      {showAll && filteredReviews.length > 3 && (
        ...
        >
          <button
            onClick={() => {
              setShowAll(false);
              document.getElementById('screen-reviews')?.scrollIntoView({ behavior: 'smooth', block: 'start' });
            }}
