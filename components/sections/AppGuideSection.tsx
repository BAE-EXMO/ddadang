        ...
        <div className="max-w-3xl mx-auto space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-8">
            <a
              ...
              className="inline-flex items-center justify-center gap-3 bg-black text-white px-8 py-4 rounded-xl hover:bg-gray-800 transition-all duration-300 hover:scale-105 active:scale-95 shadow-lg hover:shadow-2xl min-w-[200px]"
            >
              ...
              <div className="text-left">
                ...
                <div className="text-sm font-semibold">Android 다운로드</div>
              </div>
            </a>
            ...
            >
              ...
              <div className="text-left">
                <div className="text-xs opacity-80">App Store</div>
                <div className="text-sm font-semibold">iOS 다운로드</div>
              </div>
            </a>
          </div>
